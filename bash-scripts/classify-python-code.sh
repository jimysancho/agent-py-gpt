        ...
        then 
          ...
          case $first_word in 
            class) 
              ...
              echo "Class: $class_name | Parent class: $parent_class | Line of code: $line_num | File: $file"
              ;;
            def|async) 
              function_info=$(get_function_info "$line")
              read method function_name args <<< $function_info 
              FUNCTION_NAME=$function_name 
              echo "Function: $function_name | Arguments: $args | Line of code: $line_num | File: $file"
              ;;
            import|from)
        ...
        then 
          ...
          case $first_word in
            def|"async def")
              ...
              echo "Method: $METHOD | Class: $CLASS_NAME | Arguments: $args | Line of code: $line_num | File: $file"
              ;;
            *)
